...
if sw_obup_2 == 1
    set(gca, 'ColorOrder', BlueDark);
    plot(t(1:K_stop(2)), h(2,1:K_stop(2)), '--', 'LineWidth', 1)
    ...
    if flag_stop(2) == 1
        ...
        plot(t(K_stop(2)), h(2,K_stop(2)), '*', 'LineWidth', 10)
    end
end

if sw_obup_3 == 1
    set(gca, 'ColorOrder', BlueDark);
    plot(t(1:K_stop(3)), h(3,1:K_stop(3)), '-.', 'LineWidth', 1)
    ...
    if flag_stop(3) == 1
        ...
        plot(t(K_stop(3)), h(3,K_stop(3)), '*', 'LineWidth', 10)
    end
end

if sw_obup_4 == 1
    set(gca, 'ColorOrder', BlueDark);
    plot(t(1:K_stop(4)), h(4,1:K_stop(4)), ':', 'LineWidth', 2)
    ...
    if flag_stop(4) == 1
        ...
        plot(t(K_stop(4)), h(4,K_stop(4)), '*', 'LineWidth', 10)
    end
end
