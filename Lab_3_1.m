...
V_1z(1,1) = V_1.*sin(psi_1);                          % проекци€ скорости на ось z [м/с]
V_1x(1,1) = V_1.*cos(psi_1);                          % проекци€ скорости на ось x [м/с]

a_1(1,1) = sqrt(j_1prd.^2 + j_1ppr.^2);                % ускорение [м/с^2]

psi_a1(1,1) = psi_1 + atan2(j_1ppr,j_1prd); % направление ускорени€ [рад]
psi_a1(1,1) = ANGLE_CORRECT( psi_a1 );
psi_a1_deg(1,1) = psi_a1 *180/pi;                         % направление ускорени€ [град]

a_1z(1,1) = a_1(1,1).*sin(psi_a1);                         % проекци€ ускорени€ на ось z [м/с^2]
a_1x(1,1) = a_1(1,1).*cos(psi_a1);                         % проекци€ ускорени€ на ось x [м/с^2]
